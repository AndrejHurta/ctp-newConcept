...
export function FirstGrayModel() {
    ...
    const textures = useShirtSectionTextures("gray", "first", true);
    const mats = createMaterials(textures, stencil) as Record<TextureKey <"gray","first">, THREE.MeshBasicMaterial> ;
